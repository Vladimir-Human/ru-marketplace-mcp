"""Entry point for the DNS-Shop MCP server.

Exposed as the ``dns-mcp`` console script. stdio is the default transport; set
...
def main() -> int:
    ...
    from dns_connector.server import mcp

    return run_server(mcp, server_name="dns")
