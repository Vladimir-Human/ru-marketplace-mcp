"""Entry point for the Lamoda MCP server.

Exposed as the ``lamoda-mcp`` console script. stdio is the default transport;
...
def main() -> int:
    ...
    from lamoda_connector.server import mcp

    return run_server(mcp, server_name="lamoda")
