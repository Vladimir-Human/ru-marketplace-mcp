...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("осталось 0 шт", False),
        ("много шт", True),
        ("477\u2009шт осталось", True),
        ("осталось 1\u202f000 шт.", True),
        ("В наличии", True),
        ("есть в наличии", True),
        ("Не осталось", False),
        ("нет в наличии", False),
        ("нет на складе", False),
        ("товар закончился", False),
        ("распродано", False),
        ("0 шт осталось", False),
        ("2 шт", None),  # pack size is not a stock statement
        ("купили 3 шт", None),
        ("в упаковке 5 шт", None),
        ("скидка 30%", None),
        ("осталось -3 шт", None),
        ("осталось +3 шт", None),
        ("осталось −3 шт", None),
        ("осталось 3–5 шт", None),
        ("осталось 3-5 шт", None),
        ("осталось 3.5 шт", None),
        ("осталось 1234 567 шт", None),
        ("осталось 3 шт, купили 20", None),
        ("осталось", None),
        (5, True),
        (0, False),
            ...
            return _FakeResponse(
                [
                    WbCardItem(
                        ...
                        review_rating=4.7,
                        feedbacks=120,
                        # Native WB requires a reported quantity for known stock.
                        total_quantity=3,
                        in_stock=True,
                        price_rub=1500.0,
                    )
