...
```bash
docker build -t ru-marketplace-mcp:2.4.0 .
```
...
docker run --rm -p 127.0.0.1:8000:8000 \
  -e MCP_HTTP_AUTH_TOKEN -e MCP_HTTP_TENANT_ID ru-marketplace-mcp:2.4.0
...
docker run --rm -p 127.0.0.1:8001:8000 \
  -e MCP_HTTP_AUTH_TOKEN -e MCP_HTTP_TENANT_ID ru-marketplace-mcp:2.4.0 yandex-mcp
```
