...
```bash
docker build -t ru-marketplace-mcp:1.7.0 .
```
...
```bash
docker run --rm -p 127.0.0.1:8000:8000 ru-marketplace-mcp:1.7.0
...
```bash
docker run --rm -p 127.0.0.1:8001:8000 ru-marketplace-mcp:1.7.0 yandex-mcp
```
