...
Ты публикуешь готовый, уже проверенный проект. Код писать не нужно — нужно
верифицировать локально то, что нельзя было проверить из песочницы, и провести
релиз.
...
именно его отсутствие скрыло ошибку, потому что на Linux mypy считает эти атрибуты
существующими.
