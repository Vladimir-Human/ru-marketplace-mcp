...
ошибаются уверенно, поэтому проект устроен вокруг проверки: 1212 офлайн-тестов,
...
are confidently wrong, so the project is arranged around verification: 1212 offline
